...
public class LinkedList<E> {
    ...
    public void addFirst(E item, PhoneType type) {// Вставка элемента в начало списка
        Node<E> newLink = new Node<E>(item, type); // Создание нового элемента
    ...
    public void addLast(E item, PhoneType type) // элемент в конец списка
    {
        Node<E> newLink = new Node<E>(item, type); // Создание нового элемента
        if (isEmpty()) // Если список не содержит элементов,
            first = newLink; // first --> newLink
    ...
    public void addIndex(E item, PhoneType type, int pos) {
        Node<E> current = first;
        ...
        Node<E> newNode = new Node<E>(item, type); // Создание нового элемента
